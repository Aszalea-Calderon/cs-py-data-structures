...
class DoublyLinkedList:
    ...
    def __repr__(self):
        ...
        return f"{str_repr[:-4]}]"  # cut off last arrow

    def add_to_head(self, value):
        """
        inserts the given value as the new head node
        """
        ...
        if self.size == 0:  # no nodes in list
    ...
    def remove_from_head(self):
        ...
        if self.size == 0:  # no elements in list
            return None  # nothing to remove (and nothing to return)
